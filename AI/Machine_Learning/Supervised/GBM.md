A gradient Boosting Machine is an ensemble learning method. The learning comes in "stages" and the [[Decision trees]] are built sequentially, attempting to correct the errors of it's predecessor.
