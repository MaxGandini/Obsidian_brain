In the context of machine learning, classification consists in a set of statistical methods and algorithms to predict the category in which an object with certain attributes falls into.
